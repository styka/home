...
| Testowanie / jakość | Z-174 – Z-188 | 14 | A.9 | 🟡 — testy DB-gated (izolacja/marketplace) + 7 bezpieczeństwa markdown + 9 sanityzacji skórek (CSS-injection) + 6 paginacji; suite 78 testów, CI je odpala. Z-170/171/172/173 w P0. Ephemeral-pg dla testów akcji (Z-174) realizowane przez DB-gating. |
...
_Ostatnia aktualizacja: 2026-06-16 - testy sanityzacji skorek (CSS-injection guard, Z-174). Suite 78 testow. P1 w toku._
