-- Raport: runbook uruchamiania testow E2E (klikaczy) przez Claude Code on the web.
-- -> widoczny w /admin/reports oraz /reports. INSERT idempotentny: ON CONFLICT (slug) DO NOTHING.
-- Tresc = kopia worldofmag/docs/e2e/uruchamianie-e2e-claude.md

INSERT INTO "Report" ("id", "title", "slug", "content", "category", "authorId", "createdAt", "updatedAt")
VALUES (
  gen_random_uuid()::text,
  'E2E (klikacze) — runbook uruchamiania dla Claude',
  'e2e-runbook-uruchamianie',
  $e2e_runbook_2026_05_31$
