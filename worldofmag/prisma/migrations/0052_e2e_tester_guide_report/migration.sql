-- Raport: instrukcja dla nietechnicznego testera — jak uruchomic testy E2E (klikacze).
-- -> widoczny w /admin/reports oraz /reports. INSERT idempotentny: ON CONFLICT (slug) DO NOTHING.
-- Tresc = kopia worldofmag/docs/e2e/instrukcja-testera-e2e.md

INSERT INTO "Report" ("id", "title", "slug", "content", "category", "authorId", "createdAt", "updatedAt")
VALUES (
  gen_random_uuid()::text,
  'E2E (klikacze) — instrukcja dla testera (krok po kroku)',
  'e2e-instrukcja-testera',
  $e2e_tester_2026_05_31$
