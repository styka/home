...
### 4.11 Języki
- **L1 TTS/audio** ✅ (P2·F3) [2026-06-07; Web Speech API] · **L2 typy ćwiczeń** ❌ (P2·F2) · **L3 gamifikacja** ❌ (P2·F3) · **L5 przypomnienia powtórek** ❌ (P1·F2, →NM3). *Dlaczego:* SRS to mocny fundament; bez przypomnień powtórki giną, bez audio/ćwiczeń ustępujemy Anki/Duolingo.
