...
- **SC6 testy jednostkowe krytycznej logiki** 🟡 [2026-06-10 — start: `node:test`+`tsx` (0 deps), `npm run test:unit`; 24 testy dla SRS, recurrence, slot-generation, wikilinks; dalej: stats, parseQuantity, medicationSchedule] — SRS, recurrence, stats, routing, slot-generation marketplace. *Dlaczego:* regresje w logice biznesowej są kosztowne; moduł QA daje strukturę.
