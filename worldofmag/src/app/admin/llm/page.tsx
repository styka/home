...
import { getLlmProviders, getAssignments, getAiCostBreakdown, getCostAlertThreshold, getUsdPlnRate, getSpeechConfig, getModelPrices } from "@/actions/llmConfig";
...
export default async function AdminLlmPage() {
  ...
  const [providers, levelSets, cost, costThreshold, usdPlnRate, speech, prices] = await Promise.all([
    getLlmProviders(),
