...
import { Shield, GitBranch, GitCommit, Clock, Hammer, MessageSquare, Settings, BookOpen, Map, Tag, MousePointerClick, FileText, Users, Activity, Database, ListChecks, StickyNote, ShoppingCart, ChefHat, PawPrint, Boxes, Palette, BookMarked } from "lucide-react"
        ...
        <section style={{ marginBottom: 24 }}>
          ...
          <div style={{ background: "var(--bg-surface)", border: "1px solid var(--border)", borderRadius: 10, overflow: "hidden" }}>
            ...
            <Link href="/admin/audyt" className="admin-tool-link" style={{ display: "flex", alignItems: "center", gap: 12, padding: "12px 16px", color: "var(--text-primary)", textDecoration: "none", borderBottom: "1px solid var(--border)" }}>
              <BookMarked size={15} style={{ color: "var(--accent-blue)", flexShrink: 0 }} />
              <span style={{ fontSize: 13 }}>Audyt — Analiza stanu projektu + wskazania</span>
              <span style={{ marginLeft: "auto", fontSize: 13, color: "var(--text-muted)" }}>→</span>
            </Link>
