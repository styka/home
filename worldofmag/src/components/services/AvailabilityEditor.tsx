...
import { getMyAvailability, setAvailability } from "@/actions/services";
...
/** Edytor dostępności wykonawcy (M2): jedno okno godzin na dzień tygodnia. */
