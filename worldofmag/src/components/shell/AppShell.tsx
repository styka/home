...
import { Menu, X, Sparkles, ShoppingCart, Calendar, FileText, Briefcase, Settings, Brain } from "lucide-react";
...
const MODULES = [
  ...
  { id: "thoughts", label: "Thoughts", icon: <Brain size={20} />, topBarIcon: <Brain size={16} />, href: "/thoughts", active: true },
