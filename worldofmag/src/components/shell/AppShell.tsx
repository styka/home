...
const MODULES = [
  { id: "shopping", label: "Shopping", icon: <ShoppingCart size={20} />, href: "/shopping", active: true },
  { id: "calendar", label: "Calendar", icon: <Calendar size={20} />, href: "/calendar", active: false },
  { id: "notes", label: "Notes", icon: <FileText size={20} />, href: "/notes", active: false },
  { id: "work", label: "Work", icon: <Briefcase size={20} />, href: "/work", active: false },
];
